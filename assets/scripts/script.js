...
function start() { // Inicio da função start()
    ...
    function placar() {
        ...
        $("#placar").html("<h2> Pontos: " + pontos + " <img src='assets/imgs/placar_amigo.png'/>: " + salvos + " <img src='assets/imgs/placar_amigo_morte.png'/>: " + perdidos + 
        " <img src='assets/imgs/placar_inimigo1.png'/>: "  +inimigo1 + " <img src='assets/imgs/placar_inimigo2.png'/>: "  + inimigo2  +   "</h2>");
